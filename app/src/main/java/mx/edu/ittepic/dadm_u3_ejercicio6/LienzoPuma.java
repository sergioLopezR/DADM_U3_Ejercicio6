...
public class LienzoPuma extends View {

    Imagen principal, prod1_1, prod2_2, prod3_3, prod4_4, prod1, prod2, prod3, prod4, puntero, precio1, precio2, precio3, precio4;

    public LienzoPuma(Context context) {
        super(context);
        puntero = null;
        principal = new Imagen(R.drawable.puma, 130, 300, this);

        prod1_1 = new Imagen(R.drawable.prod1_1pumas, 100, 550, this);
        prod1 = new Imagen(R.drawable.prod1pumas, 620, 10, this);
        precio1 = new Imagen(R.drawable.precio1pumas, 630, 840, this);

        prod2_2 = new Imagen(R.drawable.prod2_2pumas, 100, 950, this);
        prod2 = new Imagen(R.drawable.prod2pumas, 620, 10, this);
        precio2 = new Imagen(R.drawable.precio2pumas, 630, 840, this);

        prod3_3 = new Imagen(R.drawable.prod3_3pumas, 100, 1350, this);
        prod3 = new Imagen(R.drawable.prod3pumas, 620, 10, this);
        precio3 = new Imagen(R.drawable.precio3pumas, 630, 840, this);

        prod4_4 = new Imagen(R.drawable.prod4_4pumas, 100, 1750, this);
        prod4 = new Imagen(R.drawable.prod4pumas, 620, 10, this);
        precio4 = new Imagen(R.drawable.precio4pumas, 630, 840, this);
