...
public class LienzoReebok extends View {

    Imagen principal, prod1_1, prod2_2, prod3_3, prod4_4, prod1, prod2, prod3, prod4, puntero, precio1, precio2, precio3, precio4;

    public LienzoReebok(Context context) {
        super(context);
        puntero = null;
        principal = new Imagen(R.drawable.reebok, 70, 220, this);

        prod1_1 = new Imagen(R.drawable.prod1_1reebok, 100, 550, this);
        prod1 = new Imagen(R.drawable.prod1reebok, 620, 10, this);
        precio1 = new Imagen(R.drawable.precio1reebok, 630, 840, this);

        prod2_2 = new Imagen(R.drawable.prod2_2reebok, 100, 950, this);
        prod2 = new Imagen(R.drawable.prod2reebok, 620, 10, this);
        precio2 = new Imagen(R.drawable.precio2reebok, 630, 840, this);

        prod3_3 = new Imagen(R.drawable.prod3_3reebok, 100, 1350, this);
        prod3 = new Imagen(R.drawable.prod3reebok, 620, 10, this);
        precio3 = new Imagen(R.drawable.precio3reebok, 630, 840, this);

        prod4_4 = new Imagen(R.drawable.prod4_4reebok, 100, 1750, this);
        prod4 = new Imagen(R.drawable.prod4reebok, 620, 10, this);
        precio4 = new Imagen(R.drawable.precio4reebok, 630, 840, this);
