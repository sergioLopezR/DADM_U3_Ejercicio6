...
public class Lienzosk extends View {

    Imagen principal, prod1_1, prod2_2, prod3_3, prod4_4, prod1, prod2, prod3, prod4, puntero, precio1, precio2, precio3, precio4;

    public Lienzosk(Context context) {
        super(context);
        puntero = null;
        principal = new Imagen(R.drawable.skechers, 70, 220, this);

        prod1_1 = new Imagen(R.drawable.prod1_1sk, 100, 550, this);
        prod1 = new Imagen(R.drawable.prod1sk, 620, 10, this);
        precio1 = new Imagen(R.drawable.precio1sk, 630, 840, this);

        prod2_2 = new Imagen(R.drawable.prod2_2sk, 100, 950, this);
        prod2 = new Imagen(R.drawable.prod2sk, 620, 10, this);
        precio2 = new Imagen(R.drawable.precio2sk, 650, 840, this);

        prod3_3 = new Imagen(R.drawable.prod3_3sk, 100, 1350, this);
        prod3 = new Imagen(R.drawable.prod3sk, 620, 10, this);
        precio3 = new Imagen(R.drawable.precio3sk, 630, 840, this);

        prod4_4 = new Imagen(R.drawable.prod4_4sk, 100, 1750, this);
        prod4 = new Imagen(R.drawable.prod4sk, 620, 10, this);
        precio4 = new Imagen(R.drawable.precio4sk, 630, 840, this);
